...
public class V1_2_1__remove_layerselection_bundle_from_default_views implements JdbcMigration {
    private static final Logger LOG = LogFactory.getLogger(V1_2_1__remove_layerselection_bundle_from_default_views.class);
