...
@Oskari(TampereSearchChannel.ID)
public class TampereSearchChannel extends SearchChannel {
    ...
    public static final String ID = "TAMPERE_CHANNEL";
    public final static String SERVICE_SRS = "EPSG:3067";

    private static final String PROPERTY_SERVICE_URL = "search.channel.TAMPERE_CHANNEL.service.url";
